...
class activity_yoga15 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga15)
        ...
        txtTimer = findViewById(R.id.txt15segY15)
        pauseButton = findViewById(R.id.img15segY15)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga15, activity_yoga16::class.java)
                startActivity(intent)

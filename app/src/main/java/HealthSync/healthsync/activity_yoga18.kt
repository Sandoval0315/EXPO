...
class activity_yoga18 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_yoga18)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga18)
        ...
        txtTimer = findViewById(R.id.txt10segY18)
        pauseButton = findViewById(R.id.img10segY18)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga18, activity_yoga19::class.java)
                startActivity(intent)

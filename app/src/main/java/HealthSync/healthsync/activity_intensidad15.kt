...
class activity_intensidad15 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad15)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad15)
        ...
        pauseButton = findViewById(R.id.img30segIn15)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad15, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad15")
                startActivity(intent)
                finish()
            }
        }

...
class activity_intensidad21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad21)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad21)
        ...
        txtTimer = findViewById(R.id.txt30segIn21)
        pauseButton = findViewById(R.id.img30segIn21)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad21, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad21")
                startActivity(intent)
                finish()
            }
        }

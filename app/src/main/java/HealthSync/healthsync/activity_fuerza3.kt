...
class activity_fuerza3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza3)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza3)
        ...
        txtTimer = findViewById(R.id.txt1minF1)
        pauseButton = findViewById(R.id.img1minF1)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza3, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza3")
                startActivity(intent)
                finish()
            }
        }

...
class activity_yoga20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_yoga20)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga20)
        ...
        txtTimer = findViewById(R.id.txt15segY20)
        pauseButton = findViewById(R.id.img15segY20)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga20, activity_yoga21::class.java)
                startActivity(intent)

...
class activity_tiempovascular6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular6)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgvascular6)
        ...
        txtTimer = findViewById(R.id.txt30segT6)
        pauseButton = findViewById(R.id.img30segT6)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_tiempovascular6, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo6")
                startActivity(intent)
                finish()

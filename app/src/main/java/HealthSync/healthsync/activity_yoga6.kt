...
class activity_yoga6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga6)
        ...
        txtTimer = findViewById(R.id.txt30segY6)
        pauseButton = findViewById(R.id.img30segY6)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga6, activity_yoga7::class.java)
                startActivity(intent)

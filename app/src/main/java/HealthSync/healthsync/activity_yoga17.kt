...
class activity_yoga17 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_yoga17)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga17)
        ...
        txtTimer = findViewById(R.id.txt15segY17)
        pauseButton = findViewById(R.id.img15segY17)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga17, activity_yoga18::class.java)
                startActivity(intent)

...
class activity_intensidad11 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad11)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad11)
        ...
        txtTimer = findViewById(R.id.txt30segIn11)
        pauseButton = findViewById(R.id.img30segIn11)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad11, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad11")
                startActivity(intent)
                finish()
            }
        }

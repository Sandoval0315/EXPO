...
class activity_tiempovascular24 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular24)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgvascular24)
        ...
        txtTimer = findViewById(R.id.txt30segT24)
        pauseButton = findViewById(R.id.img30segT24)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_tiempovascular24, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo24")
                startActivity(intent)
                finish()

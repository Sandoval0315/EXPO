...
class activity_yoga3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga3)
        ...
        txtTimer = findViewById(R.id.txt30segY3)
        pauseButton = findViewById(R.id.img30segY3)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_yoga3, activity_yoga4::class.java)
                startActivity(intent)

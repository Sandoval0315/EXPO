...
class activityfuerza5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza5)
        ...
        txtTimer = findViewById(R.id.txt30segF5)
        pauseButton = findViewById(R.id.img30seg5)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activityfuerza5, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza5")

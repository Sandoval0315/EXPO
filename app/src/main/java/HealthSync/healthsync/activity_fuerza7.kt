...
class activity_fuerza7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza7)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza7)
        ...
        txtTimer = findViewById(R.id.txt30segF7)
        pauseButton = findViewById(R.id.img30segF7)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza7, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza7")
                startActivity(intent)
                finish()
            }
        }

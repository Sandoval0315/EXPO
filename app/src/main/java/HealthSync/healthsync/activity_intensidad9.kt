...
class activity_intensidad9 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad9)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad9)
        ...
        txtTimer = findViewById(R.id.txt30segIn9)
        pauseButton = findViewById(R.id.img30segIn9)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad9, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad9")
                startActivity(intent)
                finish()
            }
        }

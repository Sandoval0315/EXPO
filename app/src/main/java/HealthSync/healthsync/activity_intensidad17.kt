...
class activity_intensidad17 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad17)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad17)
        ...
        txtTimer = findViewById(R.id.txt30segIn17)
        pauseButton = findViewById(R.id.img30segIn17)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad17, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad17")
                startActivity(intent)
                finish()
            }
        }

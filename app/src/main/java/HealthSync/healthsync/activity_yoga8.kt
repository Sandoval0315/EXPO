...
class activity_yoga8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga8)
        ...
        txtTimer = findViewById(R.id.txt30segY8)
        pauseButton = findViewById(R.id.img30segY8)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga8, activity_yoga9::class.java)
                startActivity(intent)

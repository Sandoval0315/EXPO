...
class activity_intensidad3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad3)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad3)
        ...
        txtTimer = findViewById(R.id.txt1minIn3)
        pauseButton = findViewById(R.id.img1minIn3)

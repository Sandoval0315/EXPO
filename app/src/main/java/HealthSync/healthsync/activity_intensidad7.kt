...
class activity_intensidad7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad7)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad7)
        ...
        txtTimer = findViewById(R.id.txt30segIn7)
        pauseButton = findViewById(R.id.img30segIn7)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad7, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad7")
                startActivity(intent)
                finish()
            }
        }

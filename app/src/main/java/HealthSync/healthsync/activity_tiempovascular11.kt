...
class activity_tiempovascular11 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular11)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgvascular11)
        ...
        txtTimer = findViewById(R.id.txt30segT11)
        pauseButton = findViewById(R.id.img30segT11)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_tiempovascular11, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo11")
                startActivity(intent)
                finish()

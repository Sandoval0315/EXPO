...
class activity_yoga19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_yoga19)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga19)
        ...
        txtTimer = findViewById(R.id.txt15segY19)
        pauseButton = findViewById(R.id.img15segY19)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga19, activity_yoga20::class.java)
                startActivity(intent)

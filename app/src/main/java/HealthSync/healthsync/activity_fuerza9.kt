...
class activity_fuerza9 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza9)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza9)
        ...
        txtTimer = findViewById(R.id.txt30segF9)
        pauseButton = findViewById(R.id.img30segF9)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza9, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza9")
                startActivity(intent)
                finish()
            }
        }

...
class activity_fuerza21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza21)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza21)
        ...
        txtTimer = findViewById(R.id.txt30segF21)
        pauseButton = findViewById(R.id.img30segF21)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza21, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza21")
                startActivity(intent)
                finish()
            }
        }

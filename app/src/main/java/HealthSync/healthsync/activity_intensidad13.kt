...
class activity_intensidad13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad13)
        ...
        txtTimer = findViewById(R.id.txt30segIn13)
        pauseButton = findViewById(R.id.img30segIn13)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad13, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad13")
                startActivity(intent)
                finish()
            }
        }

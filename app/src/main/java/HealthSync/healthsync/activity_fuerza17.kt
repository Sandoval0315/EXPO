...
class activity_fuerza17 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza17)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza17)
        ...
        txtTimer = findViewById(R.id.txt30segF17)
        pauseButton = findViewById(R.id.img30segF17)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza17, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza17")
                startActivity(intent)
                finish()
            }
        }

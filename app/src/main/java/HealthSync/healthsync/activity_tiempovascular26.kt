...
class activity_tiempovascular26 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular26)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgvascular26)
        ...
        txtTimer = findViewById(R.id.txt30segT26)
        pauseButton = findViewById(R.id.img30segT26)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_tiempovascular26, activity_rutinafinalizada::class.java)
                startActivity(intent)
                finish()
            }
        }

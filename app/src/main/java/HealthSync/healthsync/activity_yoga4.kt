...
class activity_yoga4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga4)
        ...
        txtTimer = findViewById(R.id.txt30segY4)
        pauseButton = findViewById(R.id.img30segY4)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga4, activity_yoga5::class.java)
                startActivity(intent)

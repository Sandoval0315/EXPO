...
class activity_tiempovascular5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular5)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgvascular5)
        ...
        txtTimer = findViewById(R.id.txt30segT5)
        pauseButton = findViewById(R.id.img30segT5)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_tiempovascular5, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo5")
                startActivity(intent)
                finish()

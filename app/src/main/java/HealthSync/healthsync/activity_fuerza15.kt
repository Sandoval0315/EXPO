...
class activity_fuerza15 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza15)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza15)
        ...
        txtTimer = findViewById(R.id.txt30segF15)
        pauseButton = findViewById(R.id.img30segF15)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza15, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza15")
                startActivity(intent)
                finish()
            }
        }

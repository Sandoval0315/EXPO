...
class activity_runnig3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_runnig3)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnregresararunnig3)
        ...
        txtTimer = findViewById(R.id.txt1minrunnig3)
        pauseButton = findViewById(R.id.img1minrunnig3)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_runnig3, activity_pausaru::class.java)
                intent.putExtra("identificador", "Runnig3")
                startActivity(intent)
                finish()

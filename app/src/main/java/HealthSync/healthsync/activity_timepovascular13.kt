...
class activity_timepovascular13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_timepovascular13)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgvascular13)
        ...
        txtTimer = findViewById(R.id.txt30segT13)
        pauseButton = findViewById(R.id.img30segT13)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_timepovascular13, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo13")
                startActivity(intent)
                finish()

...
class activity_fuerza19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza19)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza19)
        ...
        txtTimer = findViewById(R.id.txt30segF19)
        pauseButton = findViewById(R.id.img30segF19)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza19, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza19")
                startActivity(intent)
                finish()
            }
        }

...
class activity_yoga22 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga22)
        ...
        txtTimer = findViewById(R.id.txt15segY22)
        pauseButton = findViewById(R.id.img15segY22)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga22, activity_yoga23::class.java)
                startActivity(intent)

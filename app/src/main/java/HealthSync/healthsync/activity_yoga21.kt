...
class activity_yoga21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_yoga21)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga21)
        ...
        txtTimer = findViewById(R.id.txt1minY21)
        pauseButton = findViewById(R.id.img1minY21)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga21, activity_yoga22::class.java)
                startActivity(intent)

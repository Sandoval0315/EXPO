...
class activity_intensidad19 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad19)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad19)
        ...
        txtTimer = findViewById(R.id.txt30segIn19)
        pauseButton = findViewById(R.id.img30segIn19)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_intensidad19, activiti_pausai::class.java)
                intent.putExtra("identificador", "intensidad19")
                startActivity(intent)
                finish()
            }
        }

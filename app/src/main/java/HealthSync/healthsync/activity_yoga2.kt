...
class activity_yoga2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtTimer = findViewById(R.id.txt30segY2)
        pauseButton = findViewById(R.id.img30segY2)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_yoga2, activity_yoga3::class.java)
                startActivity(intent)

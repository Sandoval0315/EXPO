...
class activity_intensidad23 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_intensidad23)
        ...
        val regresaraInicio = findViewById<ImageButton>(R.id.btnimgintensidad23)
        ...
        txtTimer = findViewById(R.id.txt30segIn23)
        pauseButton = findViewById(R.id.img30segIn23)

...
class activity_yoga7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga7)
        ...
        txtTimer = findViewById(R.id.txt30segY7)
        pauseButton = findViewById(R.id.img30segY7)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga7, activity_yoga8::class.java)
                startActivity(intent)

...
class activity_runnig1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_runnig1)
        ...
        txtTimer = findViewById(R.id.txt1minrunnig1)
        pauseButton = findViewById(R.id.img1minrunnig1)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_runnig1, activity_pausaru::class.java)
                 intent.putExtra("identificador", "Runnig1")
                startActivity(intent)
                finish()

...
class activity_yoga13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgyoga13)
        ...
        txtTimer = findViewById(R.id.txt15segY13)
        pauseButton = findViewById(R.id.img15segY13)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_yoga13, activity_yoga14::class.java)
                startActivity(intent)

...
class activity_fuerza13 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza13)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza13)
        ...
        txtTimer = findViewById(R.id.txt30segF13)
        pauseButton = findViewById(R.id.img30segF13)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza13, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza13")
                startActivity(intent)
                finish()
            }
        }

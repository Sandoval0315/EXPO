...
class activity_tiempovascular8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tiempovascular8)
        ...
        txtTimer = findViewById(R.id.txt30segT8)
        pauseButton = findViewById(R.id.img30segT8)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@activity_tiempovascular8, activity_tomadescaso2::class.java)
                intent.putExtra("identificador", "tiempo8")

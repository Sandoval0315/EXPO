...
class activity_fuerza11 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fuerza11)
        ...
        val regresaraInicio = findViewById<ImageView>(R.id.btnimgregrezarfuerza11)
        ...
        txtTimer = findViewById(R.id.txt30segF11)
        pauseButton = findViewById(R.id.img30segF11)
    ...
    private fun createCountDownTimer(timeInMillis: Long): CountDownTimer {
        return object : CountDownTimer(timeInMillis, 1000) {
            ...
            override fun onFinish() {
                txtTimer.text = "00:00"
                val intent = Intent(this@activity_fuerza11, activity_pausaf::class.java)
                intent.putExtra("identificador", "fuerza11")
                startActivity(intent)
                finish()
            }
        }
